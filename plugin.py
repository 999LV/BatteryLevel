...
class BasePlugin:
    ...
    def onStart(self):
        ...
        try:
            vmajor = int(Parameters["DomoticzVersion"].split('.')[0])
            vminor = int(Parameters["DomoticzVersion"].split('.')[1])
            if vmajor < 2020 and vminor < 11253:  # new numbering of domoticz versions implemented 22 March 2020
                Domoticz.Error(
